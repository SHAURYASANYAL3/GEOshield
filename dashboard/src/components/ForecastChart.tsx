...
export default function ForecastChart() {
  ...
  useEffect(() => {
    // Fake some more points based on forecast.json structure
    const times = ["08:00", "09:00", "10:00", "11:00", "12:00", "13:00"];
    const actual = [2000, 2500, 3100, 3800, 4000, null];
    const predicted = [null, null, null, null, 3800, 4500];
    const upper = [null, null, null, null, 5200, 6000];
  ...
  return (
    <div className="w-full bg-card p-6 rounded-xl border border-gray-800 shadow-xl">
      <h3 className="text-lg font-bold mb-4 font-mono text-gray-300">GEO Electron Flux (pfu)</h3>
